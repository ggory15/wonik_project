#ifndef INCLUDE_wonik_LOCALIZATION_UTIL_H_
#define INCLUDE_wonik_LOCALIZATION_UTIL_H_

#include <wonik_common/Matrix.h>
...
#endif /* INCLUDE_wonik_LOCALIZATION_UTIL_H_ */
